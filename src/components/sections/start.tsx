...
const Start: React.FC<StartProps> = ({
    ...
    return (
        <div className="flex p-4 bg-white lg:h-[66vh] rounded-lg flex-col md:flex-row items-center justify-center lg:py-16 md:p-8 lg:py-16 lg:px-8 lg:max-w-7xl mx-auto">
