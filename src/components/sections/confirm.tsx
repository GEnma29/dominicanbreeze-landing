...
const ConfirmSection = () => {
    return (
        <div className="flex max-w-7xl mb-3 bg-white flex-col justify-center items-center rounded-lg px-4 py-5 sm:p-6">
            <h1 className="text-center leading-10 text-3xl font-semibold  text-emerald-900">POR FAVOR, LEE DETENIDAMENTE </h1>
            <div className='flex flex-col md:flex-row justify-center items-center'>
                ...
                <Image className="rounded-lg mb-6 mr-12" src={Image2} alt="Payment" width={200} height={200} />
            </div>
            <p className='text-center py-2'>Si  confirmas que cuentas con los requisitos económicos mínimos explicados en las preguntas, ya has cualificado para recibir la orientación privada de este hermoso proyecto con nuestro Broker.</p>
            <h3 className='flex text-center font-semibold text-lg text-center mt-4'>
                ¿Confirmas que posees la capacidad económica para realizar una inversión en la República Dominicana?
            </h3>
